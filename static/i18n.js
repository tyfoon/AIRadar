...
const TRANSLATIONS = {
  ...
  en: {
    ...
    // Other Usage page (legacy — replaced by Family)
    'other.title':         'Family Usage',
    'other.subtitle':      'Social, games, streaming, shopping and other detected traffic',
    'other.refresh':       'Refresh',
    'other.noData':        'No family usage detected yet.',
    'other.hits':          'hits',
    ...
    // Family page
    'family.title':             'Family',
    'family.subtitle':          'Household lifestyle — social, games, streaming, shopping, and more',
    'family.tab.overview':      'Overview',
    'family.tab.categories':    'Categories',
    'family.tab.rules':         'Rules',
    'family.noData':            'No family usage in the last 24 h.',
    ...
    'family.rules.header':      'Family rules live on the Rules page',
  ...
  nl: {
    ...
    // Overig Gebruik pagina (legacy — vervangen door Gezin)
    'other.title':         'Gezinsgebruik',
    'other.subtitle':      'Sociaal, games, streaming, winkelen en ander gedetecteerd verkeer',
    'other.refresh':       'Vernieuwen',
    'other.noData':        'Nog geen gezinsgebruik gedetecteerd.',
    'other.hits':          'hits',
    ...
    // Gezin pagina
    'family.title':             'Gezin',
    'family.subtitle':          'Levensstijl thuis — sociaal, games, streaming, winkelen en meer',
    'family.tab.overview':      'Overzicht',
    'family.tab.categories':    'Categorieën',
    'family.tab.rules':         'Regels',
    'family.noData':            'Geen gezinsgebruik in de laatste 24 uur.',
    ...
    'family.rules.header':      'Gezinsregels staan op de Regels-pagina',
